...
<svg width="146px" height="213px" viewBox="0 0 146 213" version="1.1" xmlns="http://www.w3.org/2000/svg">
  <g class="InstructionRobot" fill-rule="evenodd" stroke="none" stroke-width="1" fill="#000000">
    ...
    <circle class="DoorHandle" cx="87" cy="141" r="4"  fill="none" stroke="#000000" stroke-width="3"/>
...
var existingAnimation = ['eyes-up-down', 'eyes-left-right', 'blink-eyes', 'lights']
var animationClass = ['.Eyes', '.Eyes', '.Eyes', '.LightLines']

var minimumDelay = 2000
var variableDelay = 8000
...
function loop (previousAnimation) {
  var currentAnimation = selectAnimation(previousAnimation)
...
setTimeout(function () {
  var firstAnimation = selectAnimation(-1)
  reloadAnimation(-1, firstAnimation)
  loop(firstAnimation)
}, minimumDelay)
