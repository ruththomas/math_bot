  ...
  <div class="col-8 user-profile-controls" style="display: flex;">
    ...
    <div class="profile-text">
      ...
      <div class="profile-text-footer">
        <span class="nav-links about" @click.native="gotoMarketing">About</span>
        <span class="nav-links sign-in" v-if="!auth.authenticated" @click.native="auth.login">Sign In</span>
